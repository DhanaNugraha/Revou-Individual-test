...
from views.product import create_product_view, get_product_detail_view, list_products_view, update_product_view
...
def specific_product_route(product_id):
    match request.method.lower():
        ...
        # case "delete":
        #     return delete_product_view(current_user, product_id)
