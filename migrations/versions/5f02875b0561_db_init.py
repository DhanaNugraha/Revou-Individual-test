...
Revision ID: 5f02875b0561
Revises: 
Create Date: 2025-04-15 20:53:34.736338
...
def upgrade():
    ...
    sa.Column('is_locally_produced', sa.Boolean(), nullable=True),
    sa.Column('production_location', sa.String(length=100), nullable=True),
    sa.Column('carbon_footprint', sa.Numeric(precision=10, scale=2), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['attribute_id'], ['sustainability_attributes.id'], ),
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], ),
    ...
    sa.PrimaryKeyConstraint('product_id', 'tag_id', 'id')
    )
