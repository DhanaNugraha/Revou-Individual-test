...
def test_update_product_details(client, mock_update_product_data, mock_vendor_token_data, mock_vendor_data, db, products_data_inject):
    register_vendor = client.post("/auth/register", json=mock_vendor_data)

    assert register_vendor.status_code == 201

    product = client.put("/products/1", json=mock_update_product_data, headers=mock_vendor_token_data)
...
def test_update_product_name_validation_error (client, mock_update_product_data, mock_vendor_token_data, mock_vendor_data):
    register_vendor = client.post("/auth/register", json=mock_vendor_data)
...
def test_update_product_description_validation_error (client, mock_update_product_data, mock_vendor_token_data, mock_vendor_data):
    register_vendor = client.post("/auth/register", json=mock_vendor_data)
...
def test_update_product_price_validation_error (client, mock_update_product_data, mock_vendor_token_data, mock_vendor_data):
    register_vendor = client.post("/auth/register", json=mock_vendor_data)
...
def test_update_product_tags_validation_error (client, mock_update_product_data, mock_vendor_token_data, mock_vendor_data):
    register_vendor = client.post("/auth/register", json=mock_vendor_data)
...
def test_update_product_sustainability_attributes_validation_error (client, mock_update_product_data, mock_vendor_token_data, mock_vendor_data):
    register_vendor = client.post("/auth/register", json=mock_vendor_data)
...
def test_update_product_stock_validation_error (client, mock_update_product_data, mock_vendor_token_data, mock_vendor_data):
    register_vendor = client.post("/auth/register", json=mock_vendor_data)
...
def test_update_product_order_quantity_validation_error (client, mock_update_product_data, mock_vendor_token_data, mock_vendor_data):
    register_vendor = client.post("/auth/register", json=mock_vendor_data)
